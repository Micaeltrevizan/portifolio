    ...
    with tab3:
        ...
        with st.container():
                ...
                with col2:
                    ...
                    st.image("data_-sience.jpg", width=250)
        ...
        with st.container():
                ...
                with col6:
                    ...
                    st.image("cimatec.png", width=300)
